...
<head>
  ...
  <title>POLYNEROMA — Lite Polymarket UI</title>
  <meta name="description" content="POLYNEROMA — a lite, fast Polymarket-style UI for markets, portfolio, and real-time analytics." />
        ...
        <div class="absolute right-0 top-0 h-full w-[320px] max-w-[85vw] glass shadow-xl p-4">
          ...
          <div class="mt-4 space-y-2">
            ...
            <a class="block rounded-md px-3 py-2 hover:bg-accent text-muted-foreground hover:text-white"
               href="https://x.com/polyneromaxyz">X</a>
          </div>
        </div>
      </div>
      ...
      <footer>
        <div class="flex flex-col md:flex-row justify-between items-center py-8 px-4 md:px-0 text-center md:text-left gap-4 md:gap-0">
          <p class="text-muted-foreground text-[14px]">
            ...
            <span> Follow us on
              <a class="underline hover:text-[#3b82f6] transition-colors" href="https://x.com/polyneromaxyz">X</a>.
            </span>
          </p>
        </div>
      </footer>
